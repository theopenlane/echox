...
func TestDefaultBinder_BindToStructFromMixedSources(t *testing.T) {
	...
	var testCases = []struct {
		...
		},
		{
			...
			expectError:  "code=400, message=Unmarshal type error: expected=echox.Opts, got=array, field=, offset=1, internal=json: cannot unmarshal array into Go value of type echox.Opts",
		},
